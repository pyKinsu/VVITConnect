...
export function Footer() {
  return (
    <footer className="w-full border-t border-white/10 bg-gray-900 text-white">
      <div className="mx-auto max-w-7xl flex flex-col gap-10 px-6 py-12">
        
        {/* School Info first on mobile */}
        ...
        {/* Quick Links and Contact side by side on mobile, desktop as before */}
